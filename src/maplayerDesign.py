...
class Ui_FormKml(object):
    def setupUi(self, FormKml):
        ...
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(FormKml)
        self.verticalLayout_2.setObjectName(_fromUtf8("verticalLayout_2"))
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName(_fromUtf8("horizontalLayout"))
        self.label = QtWidgets.QLabel(FormKml)
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName(_fromUtf8("label"))
        self.horizontalLayout.addWidget(self.label)
        self.toolButton_input = QtWidgets.QToolButton(FormKml)
        ...
        self.lineEdit_input = QtWidgets.QLineEdit(FormKml)
        ...
        self.label_2 = QtWidgets.QLabel(FormKml)
        self.label_2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.horizontalLayout_2.addWidget(self.label_2)
        self.toolButton_output = QtWidgets.QToolButton(FormKml)
        ...
        self.lineEdit_output = QtWidgets.QLineEdit(FormKml)
        ...
        self.pushButton_OK = QtWidgets.QPushButton(FormKml)
        self.pushButton_OK.setObjectName(_fromUtf8("pushButton_OK"))
        self.horizontalLayout_3.addWidget(self.pushButton_OK)
        self.pushButton_Cancel = QtWidgets.QPushButton(FormKml)
        self.pushButton_Cancel.setObjectName(_fromUtf8("pushButton_Cancel"))
        self.horizontalLayout_3.addWidget(self.pushButton_Cancel)
        self.verticalLayout_2.addLayout(self.horizontalLayout_3)
        self.progressBar = QtWidgets.QProgressBar(FormKml)
